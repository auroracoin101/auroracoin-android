...
import com.auroracoin.core.network.CoinAddress;
import com.auroracoin.stratumj.ServerAddress;
...
public class Constants {
    ...
    public static final String SECOND_EXCHANGE_CURRENCY = "USD";
    ...
    public static final String BINARY_URL = "https://github.com/aurarad/auroracoin-coinomi/releases";

    public static final String VERSION_URL = "https://coinomi.com/version";
    public static final String SUPPORT_EMAIL = "support@aurarad.is";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(

                    new CoinAddress(AuroracoinMain.get(),
                    new ServerAddress("electrum1.auroracoin.is", 50001),
                    new ServerAddress("electrum2.auroracoin.is", 50001),
                    new ServerAddress("electrum3.auroracoin.is", 50001),
                    new ServerAddress("electrum4.auroracoin.is", 50001)
            )
    );
    ...
    public static final CoinType DEFAULT_COIN = AuroracoinMain.get();
    public static final List<CoinType> DEFAULT_COINS = ImmutableList.of((CoinType) AuroracoinMain.get());
    public static final ArrayList<AuroracoinMain> DEFAULT_TEST_COIN_IDS = Lists.newArrayList(
            AuroracoinMain.get()
    );

    public static final ImmutableList<AuroracoinMain> SUPPORTED_COINS = ImmutableList.of(
            AuroracoinMain.get()
    );
}
