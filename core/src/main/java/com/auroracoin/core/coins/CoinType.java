package com.auroracoin.core.coins;
...
import com.auroracoin.core.util.MonetaryFormat;
...
abstract public class CoinType extends NetworkParameters implements ValueType, Serializable {
    ...
    /**
        Return an address prefix, otherwise and empty string
     */
     ...
     * Use {@link com.auroracoin.core.coins.CoinType:oneCoin}
     */
    @Deprecated
